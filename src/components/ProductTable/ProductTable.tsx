...
import { DeletButton } from "../DeletButton/DeleButton";


const ProductTable = () => {

    //Carialbe que va a contener los datos recibidos por la API
    ...
    //Se inicializa un producto vacio cuando vayamos a crar uno nuevo, para evitar "undefined"
